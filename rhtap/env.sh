...
export IMAGE_URL=${IMAGE_URL-rhtap-quay-quay-rhtap-quay.apps.rosa.xjiang0417417.7bks.p3.openshiftapps.com/rhtap/rhtap-qe-python:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/xjiangorg/r1r5za6qo-python-gitops
